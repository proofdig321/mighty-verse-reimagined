...
export async function PATCH(request: Request) {
  ...
  // Deterministic intake → asset linkage is now handled at ingest time via intake_id
  // passed through the upload session. The heuristic "link-asset" action has been removed.
  // This PATCH handler is for editing intake metadata only.
