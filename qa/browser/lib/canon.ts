...
export const CANON = {
  ...
  /** Discarded asset (formerly Livepeer, now retired) — used to verify discard/exclusion behaviour. */
  discardedAssetId: "bda79051-6bc9-497f-b0aa-12d95130290c",
  fatherRaymondUniverseId: "e22e080c-715c-4045-ba82-20474d25b2e0",
  fatherRaymondMuralId: "14938419-9477-431a-be04-511b1e205bbd",
  fatherRaymondAssetId: "5f85a6f1-1f2a-4da7-af9b-8467e58d3b9c",
  fatherRaymondPlaybackId: "014sJhmHHRL2g52G14xG00L6MTyq4zvunCsZtFStk4Wds",
  fatherRaymondBindingId: "f2bf4415-8434-4aa4-ada9-84f6dc9466ec",
  fatherRaymondTitleIncludes: "Father Raymond",
  authorityParticipantId: "866390ff-5d45-4c15-b64e-e7c0655780b8",
...
export const ROUTES = {
  ...
  authorityUniverseSentinel: `/authority/universes/${CANON.universeId}/sentinel`,
  authorityUniverseStoryboardSentinel: `/authority/universes/${CANON.universeId}/storyboard?source=sentinel`,
  ...
  authorityUnboundAsset: `/authority/media/${CANON.discardedAssetId}`,
  authorityMuxInspect: `/authority/media/inspect?assetId=${CANON.muxAssetId}`,
  authorityUnboundInspect: `/authority/media/inspect?assetId=${CANON.discardedAssetId}`,
  ...
  fatherRaymondUniverse: `/worlds/${CANON.fatherRaymondUniverseId}`,
  fatherRaymondUniverseScenes: `/worlds/${CANON.fatherRaymondUniverseId}/scenes`,
  fatherRaymondMural: `/worlds/${CANON.fatherRaymondMuralId}`,
  authorityFatherRaymondSentinel: `/authority/curate/${CANON.fatherRaymondUniverseId}/sentinel`,
  authorityFatherRaymondMedia: `/authority/media/${CANON.fatherRaymondAssetId}`,
  authorityCurateMuxAsset: `/authority/curate?asset=${CANON.muxAssetId}`,
  authorityCurateUnboundAsset: `/authority/curate?asset=${CANON.discardedAssetId}`,
  editor: "/editor",
