...
- Stage 4.9 (2026-09-16): Creative Studio workstation wiring on the existing Storyboard/Panel model. Generate Still consumes source + Sentinel observation + reference + creator directive. Unknown camera is insufficient evidence, not invented movement. Sentinel `openId` follows restored selection. Assembly offers Submit for Curation without promoting canon. Frame references count toward progress. Super Hero Ego windows unchanged. No schema migration. No Shot table.
